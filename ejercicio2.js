...
$('#ejercicio2').click(function(){
  $('#rp1Ejercicio2').html(colorCabello(personas1));
  $('#rp2Ejercicio2').html(colorCabello(personas2));
  $('#rp3Ejercicio2').html(colorCabello(personas3));
  $('#rp4Ejercicio2').html(colorCabello(personas4));
});